...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<div id="contener">
		...
		<div id="comments"><?cs if:post.Author ?>Par : <?cs var:post.Author  ?> <?cs /if ?>Tags: <?cs each:tags = post.Tags ?><div id="tags"><?cs var:tags.Tag ?></div> <?cs /each ?><?cs if:post.Permalink ?>| <a href="<?cs var:post.Permalink ?>">permalink</a><?cs /if ?></div>
		<p><?cs var:post.Description ?></p>
		</p>
		<?cs /each ?>
	    </div>
	    <div id="footer">
		<a href="http://blog.etoilebsd.net">Powered by CPlanet <?cs var:CPlanet.Version ?></a>
	    </div>
